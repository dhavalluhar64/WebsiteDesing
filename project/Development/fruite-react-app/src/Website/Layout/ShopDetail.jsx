...
function ShopDetail() {
  ...
  const product =
    allproducts.find((e) => Number(e.id) === Number(shopdetailId)) || null;

  const [DataGetLocal, setGetLocal] = useState(() => {
    const storedData = localStorage.getItem("shopDetails");
  ...
  useEffect(() => {
    if (product) {
      localStorage.setItem("shopDetails", JSON.stringify(product));

      setGetLocal(product);
    }
  }, [product, allproducts]);

  if (!product && !DataGetLocal?.id) {
                ...
                <div className="row g-4">
                  <div className="col-lg-6">
                    <div className="border rounded">
                      <a href="#">
                        <img
                          src={
                            DataGetLocal.fruitsImg || DataGetLocal.vegetableImg
                          }
                  ...
                  <div className="col-lg-6">
                    <h4 className="fw-bold mb-3">
                      {DataGetLocal.fruitsname || DataGetLocal.vegetablesname}
                    </h4>
                    <p className="mb-3">Category: {DataGetLocal.bages}</p>
                    <h5 className="fw-bold mb-3">{DataGetLocal.price} $</h5>
                    ...
                    <p className="mb-4">
                      {DataGetLocal.fruitedetials ||
                        DataGetLocal.vegetabledetials}
                    </p>
                    <div
                ...
                <div className="row g-4 fruite">
                  ...
                  <div className="col-lg-12">
                    ...
                    <div className="d-flex align-items-center justify-content-start">
                      ...
                      <div>
                        <h6 className="mb-2">Red pepper</h6>
                        <div className="d-flex mb-2">
                          <i className="fa fa-star text-secondary" />
                          <i className="fa fa-star text-secondary" />
                          <i className="fa fa-star text-secondary" />
