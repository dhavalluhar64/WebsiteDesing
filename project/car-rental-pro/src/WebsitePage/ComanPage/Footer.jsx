    ...
    <div>
          ...
          <div className="col-lg-3 col-md-6 mb-5">
            ...
            <div className="row mx-n1">
              <div className="col-4 px-1 mb-2">
                <a href>
                  <img className="w-100" src="img/gallery-1.jpg" alt="Loading..fot" />
                </a>
              </div>
              <div className="col-4 px-1 mb-2">
                <a href>
                  <img className="w-100" src="img/gallery-2.jpg" alt="Loading..fot"/>
                </a>
              </div>
              <div className="col-4 px-1 mb-2">
                <a href>
                  <img className="w-100" src="img/gallery-3.jpg" alt="Loading..fot" />
                </a>
              </div>
              <div className="col-4 px-1 mb-2">
                <a href>
                  <img className="w-100" src="img/gallery-4.jpg"alt="Loading..fot" />
                </a>
              </div>
              <div className="col-4 px-1 mb-2">
                <a href>
                  <img className="w-100" src="img/gallery-5.jpg" alt="Loading..fot"/>
                </a>
              </div>
              <div className="col-4 px-1 mb-2">
                <a href>
                  <img className="w-100" src="img/gallery-6.jpg" alt="Loading..fot" />
                </a>
              </div>
            </div>
          </div>
      ...
      <div className="container-fluid bg-dark py-4 px-sm-3 px-md-5">
        <p className="mb-2 text-center text-body">
          © <a href="#">ROYAL CARS</a>. All Rights Reserved.
        </p>
        <p className="m-0 text-center text-body">
          Designed by <a href="https://htmlcodex.com">Dhaval Luhar</a>
        </p>
      </div>
      {/* Footer End */}
      {/* Back to Top */}
